...
namespace Vostok.Clusterclient.Core.Misc
{
    ...
    {
        /// <summary>
        /// A list <see cref="IRequestModule"/>s that will be inserted into request module chain before some other module.
        /// </summary>
        public List<IRequestModule> Before { get; } = new List<IRequestModule>();

        /// <summary>
        /// A list <see cref="IRequestModule"/>s that will be inserted into request module chain after some other module.
        /// </summary>
